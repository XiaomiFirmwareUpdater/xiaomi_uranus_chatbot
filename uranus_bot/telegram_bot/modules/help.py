...
from uranus_bot.telegram_bot.messages.help import help_main_message, miui_help_message, miscellaneous_help_message, \
    info_help_message, specs_help_message, custom_recovery_help_message, vendor_help_message, firmware_help_message, \
    eu_help_message
...
async def show_help(event):
    ...
    if not event.is_private:
        await event.respond("Open help in PM", buttons=[
